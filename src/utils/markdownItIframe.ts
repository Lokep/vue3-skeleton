...
export default function iframe_plugin(md: MarkdownIt, options: {
  ...
  function iframe(state: any, startLine: number, endLine: number, silent: boolean) {
    var ch, token
